...
$GLOBALS['TL_LANG']['tl_node']['popupDelay'] = ['Delay', 'Here you can enter the time that should pass before the popup is displayed.'];
$GLOBALS['TL_LANG']['tl_node']['popupTimeout'] = ['Timeout', 'Here you can enter the time in which the popup should not be displayed again after the user has closed it.'];
